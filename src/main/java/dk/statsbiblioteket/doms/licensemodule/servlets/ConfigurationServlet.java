    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if ("save_presentationtype".equals(event)) {
                ...
                LicenseModuleFacade.persistDomLicensePresentationType(IpUtil.getClientIpAddress(request),key,value,value_en);
                ...
                LicenseModuleFacade.persistDomLicenseGroupType(IpUtil.getClientIpAddress(request),key,value_dk,value_en,description,description_en,query, isMustGroup);
                ...
                LicenseModuleFacade.persistDomAttributeType(IpUtil.getClientIpAddress(request),value);
                ...
                LicenseModuleFacade.deleteDomPresentationType(IpUtil.getClientIpAddress(request),typeName);
            }
            else if ("deleteGroupType".equals(event)) {
                log.debug("deleteGroup called");
                request.setAttribute("tab", "2");
                String typeName = request.getParameter("typeName");				                                                           				
                LicenseModuleFacade.deleteDomLicenseGroupType(IpUtil.getClientIpAddress(request),typeName);
            }
            else if ("deleteAttributeType".equals(event)) {
                log.debug("deleteAttributeType called");
                request.setAttribute("tab", "3");
                String typeName = request.getParameter("typeName");				                                                           				
                LicenseModuleFacade.deleteDomAttributeType(IpUtil.getClientIpAddress(request),typeName);
            }
                ...
                LicenseModuleFacade.updateDomLicenseGroupType(IpUtil.getClientIpAddress(request),Long.parseLong(id),value, value_en,description,description_en, query, isMustGroup);
            }						
                ...
                LicenseModuleFacade.updateDomPresentationType(IpUtil.getClientIpAddress(request),Long.parseLong(id),value, value_en);
            }						
            else {								
