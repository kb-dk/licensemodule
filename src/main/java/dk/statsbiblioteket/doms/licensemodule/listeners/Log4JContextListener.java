        ...
        try {
            ...
            if (log4jFile != null) {
                if (log4jFile.matches(".*\\.xml")) {                
                    ...
                    LogManager.getLogger(Log4JContextListener.class).warn("Unrecognized log4j configuration extension '" +
                            log4jFile + "', using default log4j configuration");
                }
            } else {
                LogManager.getLogger(Log4JContextListener.class).
                        warn("Context parameter '" + applicationName + ".log4jFileName' not found, using default log4j configuration");
            }
        } catch (Exception e) {
           e.printStackTrace();
